...
description: Read-only-preferred review of auth boundaries, injection, secrets, permissions, dependencies.
model_profile: balanced_reasoning
---

# Security Reviewer (Codex implementation agent)
...
> Canonical definition: `system-building-os/agents/implementation/security-reviewer.md`
